const createButtonStyle = (isDisabled) => {
  const buttonTypeStyle = {
    ...
    allFullSquarePrimary: `w-full h-full rounded-[3px] ${!isDisabled ? 'bg-gradient-to-r from-pointOrange to-pointPink' : 'cursor-not-allowed bg-grayMedium'}`,
    ...
    mediumSquareBlack: `w-[180px] h-[42px] bg-blackSecondary border-whiteSecondary-500 border ${!isDisabled ? '' : 'cursor-not-allowed bg-grayMedium'}`,
