const createButtonStyle = (isDisabled) => {
  const buttonTypeStyle = {
    ...
    mediumSqaureBlack: `w-[180px] h-[42px] bg-blackSecondary border-whiteSecondary-500 border rounded-[3px] ${!isDisabled ? '' : 'cursor-not-allowed bg-grayMedium'}`,
    mediumSqaurePrimary: `w-[180px] h-[42px] rounded-[3px] ${!isDisabled ? 'bg-gradient-to-r from-pointOrange to-pointPink' : 'cursor-not-allowed bg-grayMedium'}`,
  };
